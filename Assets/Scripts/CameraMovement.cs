...
public class CameraMovement : MonoBehaviour
{
    ...
    [SerializeField] private float moveLeftAreaSize = 30f;
    [SerializeField] private float moveRightAreaSize = 30f;
    [SerializeField] private float moveUpAreaSize = 25f;
    [SerializeField] private float moveDownAreaSize = 25F;
    [SerializeField] private float maxYInitial = 2f;
    [SerializeField] private float minYInitial = -2f;
    [SerializeField] private float maxXInitial = 2f;
    [SerializeField] private float minXInitial = -2F;
